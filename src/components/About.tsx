...
import { ScrollReveal, FadeUp } from "../animations/ScrollAnimations";
import { fadeUpVariants, scaleInVariants, cardVariants, headingVariants, paragraphVariants } from "../animations/variants";
  ...
  return (
    <section id="about" className="py-28 px-6 relative">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
        ...
        <ScrollReveal variants={scaleInVariants} className="relative group flex justify-center">
